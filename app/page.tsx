...
const FAQ = [
  ...
  },
  {
    ...
    a: 'Manual scoring works without a connection after the app is loaded. Camera scanning uses RiichiCam\'s private detection service, so it requires an internet connection.',
  },
];
